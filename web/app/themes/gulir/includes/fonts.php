...
if ( ! class_exists( 'Gulir_Font' ) ) {
	class Gulir_Font {

		private static $instance;
		private static $cache_key = 'gulir_gfonts_link';
		...
		static function get_gfonts() {

			if ( defined( 'GULIR_CORE_PATH' ) ) {
				$gfont_file = GULIR_CORE_PATH . 'lib/redux-framework/inc/fields/typography/googlefonts.php';
		 ...
		 *
		 * This function checks if the helper function `gulir_get_local_fonts()` exists.
		...
		static function get_local_fonts() {
			...
			// Check if the function `gulir_get_local_fonts` exists before calling it
			if ( function_exists( 'gulir_get_local_fonts' ) ) {
				return gulir_get_local_fonts();
			}
		 ...
		 * @return false|string
		 */
		static function get_all_styles( $font_family ) {
