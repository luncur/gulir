...
if ( ! function_exists( 'gulir_get_list_small_3' ) ) {
	 ...
	 * @return false|string
	 */
	function gulir_get_list_small_3( $settings = [], $_query = null ) {
		...
		if ( ! $_query->have_posts() || $_query->post_count < $min_posts ) {
			...
			gulir_loop_list_small_3( $settings, $_query );
...
if ( ! function_exists( 'gulir_loop_list_small_3' ) ) {
	/**
	 * @param  $settings
	 * @param  $_query
	 */
	function gulir_loop_list_small_3( $settings, $_query ) {
