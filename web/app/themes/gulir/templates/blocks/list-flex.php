...
if ( ! function_exists( 'gulir_get_list_flex' ) ) {
	 ...
	 * @return false|string
	 */
	function gulir_get_list_flex( $settings = [], $_query = null ) {
		...
		if ( ! $_query->have_posts() ) {
			...
			gulir_loop_list_flex( $settings, $_query );
...
if ( ! function_exists( 'gulir_loop_list_flex' ) ) {
	/**
	 * @param  $settings
	 * @param  $_query
	 */
	function gulir_loop_list_flex( $settings, $_query ) {
