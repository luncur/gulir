...
if ( ! function_exists( 'gulir_get_overlay_2' ) ) {
	 ...
	 * @return false|string
	 */
	function gulir_get_overlay_2( $settings = [], $_query = null ) {
		...
		if ( ! $_query->have_posts() ) {
			...
			gulir_loop_overlay_2( $settings, $_query );
...
if ( ! function_exists( 'gulir_loop_overlay_2' ) ) {
	/**
	 * @param  $settings
	 * @param  $_query
	 */
	function gulir_loop_overlay_2( $settings, $_query ) {
