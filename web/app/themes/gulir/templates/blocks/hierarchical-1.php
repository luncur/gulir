...
if ( ! function_exists( 'gulir_get_hierarchical_1' ) ) {
	 ...
	 * @return false|string
	 */
	function gulir_get_hierarchical_1( $settings ) {
		...
		if ( ! $_query->have_posts() || $_query->post_count < $min_posts ) {
			...
			gulir_loop_hierarchical_1( $settings, $_query );
...
if ( ! function_exists( 'gulir_loop_hierarchical_1' ) ) {
	/**
	 * @param  $settings
	 * @param  $_query
	 */
	function gulir_loop_hierarchical_1( $settings, $_query ) {
