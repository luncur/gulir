...
if ( ! function_exists( 'gulir_render_single_standard_4' ) ) {
	function gulir_render_single_standard_4() {
		...
		if ( gulir_is_category_style_none_bg( gulir_get_option( 'single_post_entry_category' ) ) ) {
				...
				<div class="rb-s-container edge-padding">
					<div class="single-header-inner">
						<div class="s-feat-holder">
							<?php if ( gulir_get_single_breadcrumb() ) : ?>
								<div class="breadcrumb-absolute light-scheme"><?php gulir_single_breadcrumb(); ?></div>
							<?php endif;
							gulir_single_featured_image( $crop_size, [ 'class' => 'featured-img' ] ); ?>
						</div>
