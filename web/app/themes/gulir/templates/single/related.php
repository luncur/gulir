...
if ( ! function_exists( 'gulir_get_layout_related_1' ) ) {
	function gulir_get_layout_related_1( $settings ) {

		if ( empty( $settings['post_id'] ) ) {
			$settings['post_id'] = get_the_ID();
		}

		$_query = gulir_get_related_data( $settings );
...
if ( ! function_exists( 'gulir_get_layout_related_2' ) ) {
	function gulir_get_layout_related_2( $settings ) {
		...
		<div class="<?php echo esc_attr( $class_name ); ?>">
			<div class="inner block-list-small-2">
				...
				<div class="block-inner">
					<?php while ( $_query->have_posts() ) :
						$_query->the_post();
						gulir_list_small_2( $listing_params );
					endwhile;
					wp_reset_postdata();
					?></div>
			</div>
...
if ( ! function_exists( 'gulir_get_layout_related_3' ) ) {
	function gulir_get_layout_related_3( $settings ) {
...
if ( ! function_exists( 'gulir_get_layout_related_4' ) ) {
	function gulir_get_layout_related_4( $settings ) {
...
if ( ! function_exists( 'gulir_get_layout_related_5' ) ) {
	function gulir_get_layout_related_5( $settings ) {
...
if ( ! function_exists( 'gulir_get_layout_related_6' ) ) {
	function gulir_get_layout_related_6( $settings ) {
...
if ( ! function_exists( 'gulir_inline_content_related' ) ) {
	function gulir_inline_content_related( $data, $content ) {
		...
		$positions = gulir_get_single_setting( 'inline_related_pos' );

		if ( ( ! empty( $setting ) && '-1' === (string) $setting ) || empty( $positions ) ) {
			return $data;
		}

		$shortcode = trim( gulir_get_option( 'single_post_inline_related' ) );
