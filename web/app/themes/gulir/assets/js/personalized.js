/**  GULIR_PERSONALIZE */
var GULIR_PERSONALIZE = (function (Module, $) {
        'use strict';
        ...
        Module.initParams = function () {
            ...
            this.personalizeUID =
                (typeof GULIR_CORE_SCRIPT !== "undefined" && GULIR_CORE_SCRIPT.personalizeUID !== undefined)
        ...
        Module.init = function () {
            ...
            if (GULIR_CORE_SCRIPT.getCookie('personalize_sync') || this.syncInterval()) {
        ...
        Module.syncInterval = function () {
            ...
            const isLogged = GULIR_CORE_SCRIPT.getCookie('u_logged');
            const syncTimeout = !GULIR_CORE_SCRIPT.getCookie('syncTimeout');
        ...
        Module.syncPersonalizeData = function () {
            ...
            GULIR_CORE_SCRIPT.setCookie('personalize_sync', '');
            GULIR_CORE_SCRIPT.setCookie('syncTimeout', '1', self.syncTimeout);
    ...
    }(GULIR_PERSONALIZE || {}, jQuery)
)

/** init */
jQuery(document).ready(function ($) {
    GULIR_PERSONALIZE.init();
});