/**  GULIR MAN SCRIPT */
var GULIR_MAIN_SCRIPT = (function (Module, $) {
        'use strict';

        Module.initParams = function () {
            this.yesStorage = this.isStorageAvailable();
            this.themeSettings = typeof gulirParams !== 'undefined' ? gulirParams : {};
            this.galleriesData = typeof gulirGalleriesData !== 'undefined' ? gulirGalleriesData : {};
            this.ajaxURL = typeof gulirCoreParams !== 'undefined' ? gulirCoreParams.ajaxurl || '' : '';
            this.ajaxData = {};
            ...
            this.personalizeUID = (typeof GULIR_CORE_SCRIPT !== "undefined" && GULIR_CORE_SCRIPT.personalizeUID !== undefined)
                ? GULIR_CORE_SCRIPT.personalizeUID
                : 'u0';
        }
        ...
        Module.reInitAll = function () {
            ...
            this.syncLayoutLike();
            if (typeof GULIR_PERSONALIZE !== 'undefined') {
                GULIR_PERSONALIZE.syncPersonalizeLayout();
            }
        ...
        Module.reloadBlockFunc = function () {
            ...
            if (typeof GULIR_PERSONALIZE !== 'undefined') {
                GULIR_PERSONALIZE.syncLayoutBookmarks();
            }
            this.syncLayoutLike();
            this.videoPreview();
            this.hoverTipsy();
        ...
        Module.initElementor = function () {
            if ('undefined' !== typeof initDarkMode && !GULIR_MAIN_SCRIPT.editorDarkModeInit) {
                GULIR_MAIN_SCRIPT.editorDarkModeInit = true;
                initDarkMode();
            }
            GULIR_MAIN_SCRIPT.breakingNews();
            GULIR_MAIN_SCRIPT.carousels();
            GULIR_MAIN_SCRIPT.sliders();
        }
        ...
        Module.videoPlayToggle = function () {
            ...
            const players = GULIR_MAIN_SCRIPT.YTPlayers;
                        ...
                        if (param) {
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    if ('category' === search && follow && typeof GULIR_PERSONALIZE !== 'undefined') {
                                        GULIR_PERSONALIZE.syncLayoutCategories();
                                    }
                                    responseWrap.css('height', 'auto').fadeIn(200);
                                }
                            });
            ...
            if (elements.length > 0) {
                const blockRequests = elements.map(function () {
                    ...
                    if (self.ajaxData[uuid].content_source &&
                        ...
                        typeof gulirQueriedIDs !== 'undefined' && gulirQueriedIDs.data
                    ) {
                        self.ajaxData[uuid].post_not_in = gulirQueriedIDs.data;
                    }
                ...
                handler: function (direction) {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            setTimeout(function () {
                                self.reInitAll();
                                if (typeof GULIR_CORE_SCRIPT !== 'undefined') {
                                    GULIR_CORE_SCRIPT.loadGoogleAds(response);
                                    GULIR_CORE_SCRIPT.loadInstagram(response);
                                    GULIR_CORE_SCRIPT.loadTwttr();
                                }
                            }, 1);
                        }
                    });
            ...
            self.articleData.every(article => {
                if (scroll > (article.top + 5) && scroll < (article.bottom - 5)) {
                    ...
                    if (article.postID !== self.inviewPostID) {
                        ...
                        if (typeof GULIR_CORE_SCRIPT !== 'undefined') {
                            GULIR_CORE_SCRIPT.updateGA(article);
                        }
                    }
                    return false;
                }
    ...
    }(GULIR_MAIN_SCRIPT || {}, jQuery)
)

/** init */
jQuery(document).ready(function ($) {
    GULIR_MAIN_SCRIPT.init();
});
...
jQuery(window).on('elementor/frontend/init', function () {
    ...
    if (typeof elementorFrontend !== 'undefined' && typeof elementorFrontend.isEditMode === 'function' && elementorFrontend.isEditMode()) {
        GULIR_MAIN_SCRIPT.isElementorEditor = true;
        GULIR_MAIN_SCRIPT.editorDarkModeInit = false;

        elementorFrontend.hooks.addAction('frontend/element_ready/widget', GULIR_MAIN_SCRIPT.initElementor);
    }
});