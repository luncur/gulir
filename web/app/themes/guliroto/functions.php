...
function gulir_sacha_editor_customizer_styles() {
	...
	if ( $theme_customizations ) {
		...
		wp_register_style( 'gulircom-editor-inline-styles', false );
		wp_enqueue_style( 'gulircom-editor-inline-styles' );
		// Add inline styles:
		wp_add_inline_style( 'gulircom-editor-inline-styles', $theme_customizations );
	}
